...
// 		c <- 10
// 		fmt.Println("func go routine after sending data into channel")
// 	}(c1)
...
// 	d := <-c1
// 	fmt.Println("main go routine received data", d)
...
// 			fmt.Println("func go routine starts sending data into channel")
// 			c <- i
// 			fmt.Println("func goroutine generate after sending data into channel")
// 		}
// 		close(c)
// 	}(c1)
